...
import { flipFade, spinCoin, flipIn, fadeUpInOut } from "../animations";
        ...
        <section className="relative min-h-[calc(100vh-80px)] flex flex-col items-center justify-start bg-gradient-to-b from-black via-black/90 to-[#1a0010] text-white px-6 py-16 overflow-hidden">
            ...
            >
                ...
                <p className="text-gray-200 text-lg leading-relaxed mb-6">
                    BurnBaby™ was founded on the belief that every woman deserves to feel
                    powerful, confident, and unstoppable. What started as a small movement
                    to inspire healthier lifestyles has grown into a community of women
                    redefining strength and self-love.
                </p>
                <p className="text-gray-300 text-lg leading-relaxed mb-6">
                    Our mission is simple — help women reset, rebuild, and reignite their
                    inner fire. Through dedication, mindset, and movement, we empower every
                    participant to transform from the inside out.
                </p>
            ...
            >
                ...
                <p className="text-gray-300 text-base max-w-md">
                    “My mission is to help every woman rediscover her confidence, embrace
                    her body, and set her world on fire.”
                </p>
            </motion.div>
